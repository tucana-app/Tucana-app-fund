...
function Spendings(props) {
  ...
  var buttonCat1 = (
    <OverlayTrigger placement="top" overlay={<Tooltip>{cat1name}</Tooltip>}>
      <Button variant={cat1color}>1</Button>
    </OverlayTrigger>
  );
  ...
  var buttonCat2 = (
    <OverlayTrigger placement="top" overlay={<Tooltip>{cat2name}</Tooltip>}>
      <Button variant={cat2color}>2</Button>
    </OverlayTrigger>
  );

  var cat3total = 500;
  var cat3name = "Hiring a web designer for UX/UI";
  var cat3color = "secondary";
  var cat3spent = [0];
  ...
  var buttonCat3 = (
    <OverlayTrigger placement="top" overlay={<Tooltip>{cat3name}</Tooltip>}>
      <Button variant={cat3color}>3</Button>
    </OverlayTrigger>
  );

  var cat4total = 125;
  var cat4name = "Publication of the app on Android and iOS";
  var cat4color = "warning";
  ...
  var buttonCat4 = (
    <OverlayTrigger placement="top" overlay={<Tooltip>{cat4name}</Tooltip>}>
      <Button variant={cat4color}>4</Button>
    </OverlayTrigger>
  );
  ...
  var buttonCat5 = (
    <OverlayTrigger placement="top" overlay={<Tooltip>{cat5name}</Tooltip>}>
      <Button variant={cat5color}>5</Button>
    </OverlayTrigger>
  );

  var cat6total = 500;
  var cat6name = "Additional costs such as legal fees";
  var cat6color = "danger";
  var cat6spent = [0];
  ...
  var buttonCat6 = (
    <OverlayTrigger placement="top" overlay={<Tooltip>{cat6name}</Tooltip>}>
      <Button variant={cat6color}>6</Button>
    </OverlayTrigger>
  );
  ...
  return (
    <>
      <Container className="my-5">
        <Row className="mb-5">
          <Col xs={12} className="col-12 text-center">
            <h3 className="mb-0">
              <span className="text-success ms-5">Y</span>ou can find a clear
              list of our spendings.
            </h3>
            <p className="text-center">Transparency is very important to us.</p>
          </Col>
        </Row>
        <Row className="mb-5">
          <Col>
